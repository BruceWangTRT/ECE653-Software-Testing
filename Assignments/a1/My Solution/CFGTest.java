...
public class CFGTest {
    ...
    //Additional test case for Edge-Coverage of deleteNode
    @Test
    public void deleteNode_isolatedNode() {
        cfg.addNode(1000, m_m, m);
        ...
        cfg.deleteNode(1000, m_m, m);

        assertFalse(cfg.nodes.contains(n));
        assertEquals(sizeExpected - 1, cfg.nodes.size());
    }
    //Additional test case for Edge-Coverage of deleteNode over
    ...
    //Additional test case for Edge-Coverage of deleteEdge
    @Test
    ...
    //Additional test case for Edge-Coverage of deleteEdge over
    ...
    //Additional test cases for Node-Coverage 
    //and Edge-Coverage of isReachable
    @Test
    public void reachable_srcEqualsTarget(){
    	assertTrue(cfg.isReachable(0, m_m, m, 0, m_m, m));
        //cfg can be observed by
        //for(CFG.Node x:cfg.nodes){
        //	System.out.println(x.toString()+cfg.edges.get(x).toString());
        //}
    }   
    //Additional test cases for Node-Coverage 
    //and Edge-Coverage of isReachable over
}
